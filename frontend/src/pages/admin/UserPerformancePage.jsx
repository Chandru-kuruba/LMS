...
export default function AdminUserPerformancePage() {
    ...
    const handleDownloadReport = async () => {
        try {
            const response = await axios.get(`${API}/admin/reports/user/${userId}/pdf`, {
                headers: { Authorization: `Bearer ${accessToken}` },
                responseType: 'blob'
            });
            ...
            link.href = url;
            link.setAttribute('download', `progress_report_${userId}.pdf`);
        ...
        <div className="space-y-6" data-testid="admin-user-performance-page">
            ...
            <div className="flex items-center justify-between">
                ...
                <Button onClick={handleDownloadReport}>
                    <FileText className="w-4 h-4 mr-2" /> Download Progress Report
                </Button>
            </div>
