    ...
    const handleAssignCourse = async () => {
        ...
        try {
            const response = await axios.post(
                `${API}/admin/users/${selectedUser.id}/assign-course`,
                null,
                {
            ...
            toast.error(error.response?.data?.detail || "Failed to assign course");
        } finally {
    ...
    return (
        <div className="space-y-6" data-testid="admin-users-page">
            <div>
                ...
                <p className="text-slate-400">Manage users, roles, and course access</p>
            </div>
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            <button
                                                ...
                                                title={user.id === currentUser?.id ? "Cannot change own role" : `Click to make ${user.role === "admin" ? "student" : "admin"}`}
                                            >
                                                {user.role === "admin" ? (
            ...
            <Dialog open={showAssignDialog} onOpenChange={setShowAssignDialog}>
                <DialogContent className="glass-heavy border-green-500/20 max-w-md">
                    <DialogHeader>
                    ...
                    {selectedUser && (
                        <div className="space-y-4 py-4">
                            <div className="glass-light rounded-lg p-3">
                                <p className="text-xs text-slate-500">Assigning to</p>
                            ...
                            <div className="space-y-2">
                                <label className="text-slate-300 text-sm">Select Course</label>
                                ...
                                <p className="text-xs text-slate-500">
                                    User will get free access without payment. Great for friends & family!
                                </p>
                            </div>
                            ...
                            <div className="flex justify-end gap-3 pt-4 border-t border-white/10">
                                ...
                                <Button
                                    ...
                                    disabled={isAssigning || !selectedCourse}
                                >
