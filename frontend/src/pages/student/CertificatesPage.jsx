...
export default function CertificatesPage() {
    ...
    const handleDownloadTranscript = async () => {
        try {
            const response = await axios.get(`${API}/user/transcript/pdf`, {
                headers: { Authorization: `Bearer ${accessToken}` },
                responseType: 'blob'
            });
            ...
            link.href = url;
            link.setAttribute('download', `transcript_${user.id?.slice(0, 8) || 'user'}.pdf`);
    ...
    const handlePrint = async (certificate) => {
        ...
        const qrCodeUrl = `${API}/public/certificates/qr/${certificate.certificate_id}?base_url=${encodeURIComponent(window.location.origin)}`;
            ...
            <body>
                <div class="certificate">
                    ...
                    <div class="cert-id-section">
                        ...
                        <div class="verification-text">Verify at: ${verificationUrl}</div>
                    </div>
                    
                    <div class="qr-section">
                        <img src="${qrCodeUrl}" alt="Scan to Verify" class="qr-code">
